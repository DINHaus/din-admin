    ...
    <Dialog>
      ...
      >
        <DialogContentWrapper>
          ...
          <ParSm>
            You can start a new curated topic, this topic is owned and curated
            by the content creators and is ment to be a warehouse of highly
            curated content on specific topics
          </ParSm>
          <ParSm>
            Alternativly you can create a person topic, this is a place for your
            thoughts, sub topics can be shared with other top level curated
            topics
          </ParSm>
        </DialogContentWrapper>
      </DialogContent>
