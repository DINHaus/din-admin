...
export const ArticleDetails = ({
  ...
  return (
    <ArticleLayout>
      ...
      <ArticleLinks>
        {sdata?._price.result && sdata?._authorFee.result && hash && (
          <CollectButton hash={hash} link={false} />
        )}
        <Button variant="outline" size="sm">
          <StyledLink to={"comments"}>
            {" "}
            Comments <Comments badge hash={hash} />
          </StyledLink>
        </Button>
            ...
            <DialogContentWrapper>
              ...
              <ShareLinks>
                ...
                <a
                  ...
                  href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(
                    `Read this post, ${parsedContent?.title} for ${dao?.name} here: ${window.location.href}`
                  )}`}
                  target="_blank"
